...
urlpatterns = [
    ...
    path("records/", RecordsView.as_view(), name="site-records"),
    path("results/", ClubRecordView.as_view(), name="site-results"),
    path("dismissals/", DismissalsView.as_view(), name="site-dismissals"),
